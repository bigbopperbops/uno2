...
(function() {
    ...
    c.joinRoom = function(roomId, joinData, isDevRoom, serverDomainNameNeeded, successCallback, errorCallback, converter) {
        this.call(24, {
            roomid: roomId,
            joindata: joinData,
            isdevroom: isDevRoom,
    ...
    c.createJoinRoom = function(roomId, roomType, visible, roomData, joinData, isDevRoom, serverDomainNameNeeded, successCallback, errorCallback, converter) {
        this.call(27, {
            roomid: roomId,
            roomtype: roomType,
            visible: visible,
    ...
    c.leaderboardsGet = function(group, leaderboard, index, count, neighbourUserId, filterUserIds, successCallback, errorCallback, converter) {
        this.call(431, {
            group: group,
    ...
    c.leaderboardsSet = function(group, leaderboard, score, successCallback, errorCallback, converter) {
        this.call(434, {
            group: group,
            leaderboard: leaderboard,
            score: score
    ...
    c.leaderboardsCount = function(group, leaderboard, successCallback, errorCallback, converter) {
        this.call(437, {
            group: group,
            leaderboard: leaderboard
        }, successCallback, errorCallback, converter)
    ...
    _pio.leaderboards = function(channel, connectUserId) {
        ...
        this.getTop = function(group, leaderboard, index, count, filterUserIds, successCallback, errorCallback) {
            channel.leaderboardsGet(group, leaderboard, index, count, null, filterUserIds, successCallback, errorCallback, function(result) {
                if (result == null || result.leaderboardentry == null || result.leaderboardentry.length == 0) {
                    return [];
                }
                var entries = [];
